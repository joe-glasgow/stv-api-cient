...
exports["default"] = {
    ...
    results: [{
        ...
        genre: "Entertainment",
        views: null,
        _cuePoints: [659960, 1310920, 1811880],
        video: {
            id: 4275235479001,
            guid: "catchup-ac2-mez-loosewomenseries19-20150604-1228.mpg",
        ...
        genre: "Entertainment",
        views: null,
        _cuePoints: [667960, 1270920, 2204880, 2849840, 3455800, 3816760, 4701720],
        video: {
            id: 4275209613001,
            guid: "catchup-ac2-mez-thismorning2013-14-20150604-1031.mpg",
        ...
        genre: "Daytime",
        views: null,
        _cuePoints: [581960, 1474920, 2228880],
        video: {
            id: 4275017917001,
            guid: "catchup-ac2-mez-thejeremykyleshow-20150604-0925.mpg",
...
var _jsLibsStvStvBaseRequest = require('../js/libs/stv/stv-base-request');

var _jsLibsStvStvBaseRequest2 = _interopRequireDefault(_jsLibsStvStvBaseRequest);
...
// Instantiating class
describe('Construct a new request', function () {
    var noRequest = new _jsLibsStvStvBaseRequest2['default']();
    var stvRequest = new _jsLibsStvStvBaseRequest2['default']('stv');
    var playerRequest = new _jsLibsStvStvBaseRequest2['default']('player');

    it('checks that than an empty request fails', function () {
        expect(noRequest.api).toBe(undefined);
    });

    it('checks that the stv request returns correct api', function () {
        expect(stvRequest.api).toBe('stv');
    });

    it('checks that player request returns correct api', function () {
...
describe('Make an API request', function () {
    var request = new _jsLibsStvStvBaseRequest2['default']('player');
    var requestedUrl = '';
    var requestType = '';
    var successFullResponse = require('../__json__/api-sample-success');
    var failResponse = require('../__json__/api-sample-fail');
    var error = false;
    ...
    it('and checks that the url called is as expected', function () {
    ...
    it('and checks we can make API calls by type', function () {
        spyOn(request, 'makeAPIRequest').andCallThrough();
        spyOn($, 'Deferred').andCallThrough();
        spyOn($, 'ajax').andCallFake(function (e) {
            requestedUrl = e.url;
    ...
    it('and checks that url calls are made with filtering params', function () {
        var data = {};
        //stv-api-parameters
        spyOn(request, 'makeAPIRequest').andCallThrough();
        spyOn($, 'ajax').andCallFake(function (e) {
    ...
    it('and checks that a successful response returns data as expected', function () {
        var responseObj = '';
    ...
    it(' and checks that fails can be handled as expected', function () {
...
},{"../__json__/api-sample-fail":1,"../__json__/api-sample-success":2,"../js/libs/stv/stv-base-request":7,"jquery":9}],4:[function(require,module,exports){
"use strict";
...
exports["default"] = {
    _errorMessage: function _errorMessage(value, type) {
...
exports['default'] = {
    ...
    groupToken: function groupToken(value) {
        try {
            this.isNumber(value);
            // type check
    ...
    episodeGuid: function episodeGuid(value) {
        try {
            this.isString(value);
            // type check
    ...
    programmeGuid: function programmeGuid(value) {
        try {
            this.isString(value);
            // type check
    ...
    ipAddress: function ipAddress(value) {
        try {
            this.isNumber(value);
            // type check
    ...
    gigyaId: function gigyaId(value) {
        try {
            this.isString(value);
            // type check
    ...
    startLetter: function startLetter(value) {
        try {
            this.isString(value);
    ...
    setType: function setType(requestType) {
        try {
...
var _stvApiParameters = require('./stv-api-parameters');

var _stvApiParameters2 = _interopRequireDefault(_stvApiParameters);

var _exceptionsStvApiTypes = require('./exceptions/stv-api-types');

var _exceptionsStvApiTypes2 = _interopRequireDefault(_exceptionsStvApiTypes);

var _stvApiBuilder = require('./stv-api-builder');

var _stvApiBuilder2 = _interopRequireDefault(_stvApiBuilder);

var _stv = require('./stv');

// grab method to retrieve api
var apiUrl = new _stvApiBuilder2['default']();

var STVBaseAPIRequest = (function () {
    function STVBaseAPIRequest(api) {
        _classCallCheck(this, _STVBaseAPIRequest);
    ...
    var _STVBaseAPIRequest = STVBaseAPIRequest;

    _createClass(_STVBaseAPIRequest, [{
        key: 'makeAPIRequest',
        value: function makeAPIRequest() {
            // fetch request API url using APIBuilder.fetchAPI(this.api);
            var request = apiUrl.fetchAPI(this.api) + this.type + '/',
                dfd = $.Deferred();
            // make the request
            $.ajax({
                type: 'GET',
    ...
    STVBaseAPIRequest = (0, _stv.Implements)(_stvApiParameters2['default'])(STVBaseAPIRequest) || STVBaseAPIRequest;
    STVBaseAPIRequest = (0, _stv.Implements)(_exceptionsStvApiTypes2['default'])(STVBaseAPIRequest) || STVBaseAPIRequest;
    return STVBaseAPIRequest;
})();

exports['default'] = STVBaseAPIRequest;
module.exports = exports['default'];

},{"./exceptions/stv-api-types":4,"./stv":8,"./stv-api-builder":5,"./stv-api-parameters":6}],8:[function(require,module,exports){
//pollyfil for Object.assgin
'use strict';
